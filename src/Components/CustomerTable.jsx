...
function Table() {
  ...
  return (
    <section id="main-section" className="table m-0">
      <div className="gradient-custom-2 h-100 d-flex flex-column align-items-center bg-light container shadow mx-auto my-4 py-4">
        <input
          className="form-control w-75 shadow-sm rounded-3 py-2"
          id="searchByName"
          type="text"
        ...
        <input
          className="form-control w-75 mt-4 rounded-3 py-2 shadow-sm"
            ...
            <div className="row w-100">
              <div className="col-12 p-0 mb-0">
                <div className="table-responsive">
                  <table className="table rounded-5 table-bordered table-hover table-striped mb-0">
      ...
      {userChartData && (
        <div
          id="chartContainer"
          className="bg-light overflow-hidden position-absolute top-50 start-50 py-4 translate-middle">
          <button
